...
/***/ "./src/js/libs/_air-datepicker.js":
/*!****************************************!*\
  !*** ./src/js/libs/_air-datepicker.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function airDatepickerInit() {
  var datepickers = document.querySelectorAll('[data-air-datepicker]');
  datepickers.forEach(function (input) {
    var options = {
      minDate: input.hasAttribute('data-days') ? new Date() : false,
      // Опционально: запретить даты раньше текущей
      autoClose: true
    };

    // Если есть атрибут data-days, добавляем обработчик для блокировки дат
    if (input.hasAttribute('data-days')) {
      var allowedDaysStr = input.dataset.days || '';
      var allowedDays = allowedDaysStr.split(',').filter(Boolean); // Убираем пустые строки

      // Преобразуем даты в формат Date
      var parsedAllowedDays = allowedDays.map(function (dayStr) {
        var _dayStr$split = dayStr.split('.'),
          _dayStr$split2 = _slicedToArray(_dayStr$split, 3),
          day = _dayStr$split2[0],
          month = _dayStr$split2[1],
          year = _dayStr$split2[2];
        return new Date(year, month - 1, day);
      });

      // Добавляем обработчик рендеринга ячеек
      options.onRenderCell = function (_ref) {
        var date = _ref.date,
          cellType = _ref.cellType;
        if (cellType === 'day') {
          // Проверяем, разрешена ли дата
          var isAllowed = parsedAllowedDays.some(function (allowedDate) {
            return date.getDate() === allowedDate.getDate() && date.getMonth() === allowedDate.getMonth() && date.getFullYear() === allowedDate.getFullYear();
          });
          return {
            disabled: !isAllowed,
            // Блокируем все, кроме разрешенных
    ...
    new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"](input, options);
  });
}
airDatepickerInit();
...
function initChoices() {
  var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-choice]';
  ...
  selects.forEach(function (select) {
    ...
    var instance = new choices_js__WEBPACK_IMPORTED_MODULE_0__["default"](select, {
      searchEnabled: false,
      searchChoices: false,
      shouldSort: false,
      placeholder: true
...
function reinitSelect(selectElement) {
  ...
  if (typeof selectElement === 'string') {
    var elements = document.querySelectorAll(selectElement);
    elements.forEach(function (el) {
      return initChoices("#".concat(el.id));
    });
    return;
  }
  if (selectElement instanceof Node) {
    initChoices("#".concat(selectElement.id));
  } else if (selectElement.length) {
    var selector = Array.from(selectElement).map(function (el) {
      return "#".concat(el.id);
    }).join(',');
...
if (document.querySelector('[data-tabs="offices-page"]')) {
  new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('offices-page');
}
...
/* harmony import */ var _air_datepicker_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_air-datepicker.js */ "./src/js/libs/_air-datepicker.js");
...
__webpack_require__.r(__webpack_exports__);
(function () {
  var categoryButtons = document.querySelectorAll('.office-link');
  if (!categoryButtons) {
    return;
  }
...
/* harmony import */ var _offices_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_offices.js */ "./src/js/project/_offices.js");
...
/* harmony import */ var _utils_geolocation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/_geolocation.js */ "./src/js/project/map/utils/_geolocation.js");
/* harmony import */ var _utils_create_pin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/_create-pin.js */ "./src/js/project/map/utils/_create-pin.js");
...
function _initMap() {
  _initMap = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(mapElement, isBaseMap, pins, settings) {
    var _document$getElementB;
    var apiKey, ymaps3, YMap, YMapDefaultSchemeLayer, YMapDefaultFeaturesLayer, YMapControls, YMapMarker, _yield$ymaps3$import, YMapZoomControl, YMapGeolocationControl, map, controls, filterButtons, nearButton, allCloseButtons, allMarkerButtons;
      ...
      while (1) switch (_context2.n) {
        ...
        case 5:
          ...
          pins.forEach(function (pin) {
            var wrapper = (0,_utils_create_pin_js__WEBPACK_IMPORTED_MODULE_2__.createPin)(pin);
          ...
          map.addChild(new YMapDefaultSchemeLayer({
            customization: _styles_json__WEBPACK_IMPORTED_MODULE_0__
          }));
        case 6:
...
function _getData() {
  _getData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(url) {
    var response, data, pins, settings, _t2;
...
function createPin(pin) {
  ...
  (_pin$types = pin.types) === null || _pin$types === void 0 || _pin$types.forEach(function (type) {
...
/***/ "./src/js/templates/_preloader.js":
/*!****************************************!*\
  !*** ./src/js/templates/_preloader.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function showLoader() {
  var nodeElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
__webpack_require__.r(__webpack_exports__);
function counter() {
  var counters = document.querySelectorAll('.stepper');
  counters.forEach(function (counter) {
    var counterMin = parseInt(counter.getAttribute('data-stepper-min'), 10);
    var counterMax = parseInt(counter.getAttribute('data-stepper-max'), 10);
    var counterMinus = counter.querySelector('.stepper__btn--down');
    var counterPlus = counter.querySelector('.stepper__btn--up');
    var counterInput = counter.querySelector('input');
    counterInput.addEventListener('input', function () {
      var counterInput = counter.querySelector('input');
      var counterInputValue = parseInt("".concat(counterInput.value), 10);
  ...
  var checkClass = function checkClass() {
    if (burgerButton.classList.contains('burger-button--active')) {
      ...
      if (baseMenu.classList.contains('menu__base--hidden')) {
        profileButton === null || profileButton === void 0 || profileButton.setAttribute('aria-label', 'Закрыть меню профиля');
        profileButton === null || profileButton === void 0 || profileButton.setAttribute('aria-expanded', 'true');
      } else {
        profileButton === null || profileButton === void 0 || profileButton.setAttribute('aria-label', 'Открыть меню профиля');
        profileButton === null || profileButton === void 0 || profileButton.setAttribute('aria-expanded', 'false');
      }
    } else {
...
/* harmony import */ var _preloader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_preloader.js */ "./src/js/templates/_preloader.js");
